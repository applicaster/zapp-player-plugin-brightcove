...
public class BrightcovePlayerPlugin: APPlugablePlayerBase {
    ...
    /// - Returns: Creates an instance of the player view controller and, in this example, returns a BrightcovePlayerPlugin instance.
    public static func pluggablePlayerInit(playableItems items: [ZPPlayable]?, configurationJSON: NSDictionary?) -> ZPPlayerProtocol? {
        ...
        NotificationCenter.default.addObserver(instance, selector: #selector(BrightcovePlayerPlugin.playerDidFinishPlaying), name: Notification.Name.AVPlayerItemDidPlayToEndTime, object: nil)
